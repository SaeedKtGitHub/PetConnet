...
import 'package:pet_connect/view/widgets/profile/other_user_posts_list.dart';
                  ...
                  HandlingDataRequest(
                    ...
                    widget: RefreshIndicator(
                      ...
                      onRefresh: () async {
                        ...
                        controller.getUserPosts(widget.userId);
                      },
                      child: Column(
                        children: [
                      ...
                      controller.userPosts.isNotEmpty
                          ? OtherUsersPostsList(posts: controller.userPosts)
                          :Container()
                                      ],
                                    ),
                    ),
