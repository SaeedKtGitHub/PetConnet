...
import 'package:pet_connect/controller/forget_password/veirfy_code_forget_controller.dart';
...
class VerifyCodeForgetPassScreen extends StatelessWidget {
  const VerifyCodeForgetPassScreen({Key? key}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: ListView(children: [
          ...
          //CustomTextBody(numOfText: numOfText),
